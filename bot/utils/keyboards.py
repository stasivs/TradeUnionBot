...
BUTTON_HOW_TO_APPLY_FOR_MATSUPPORT = KeyboardButton('Как подать на материальную поддержку?')
...
INLINE_BUTTON_MAT_HELP_BLANK = InlineKeyboardButton(text='Бланк заявления', callback_data='get_mat_help_blank')
INLINE_BUTTON_MAT_SUPPORT_BLANK = InlineKeyboardButton(text='Бланк заявления', callback_data='get_mat_support_blank')
INLINE_BUTTON_GET_PROFCOME_SCHEDULE = InlineKeyboardButton(text='Расписание приёма документов',
                                                           callback_data='get_profcome_schedule')

INLINE_BUTTON_VK_GROUP = InlineKeyboardButton(text='Наша группа ВК', url='https://vk.com/pk_mgsu')
